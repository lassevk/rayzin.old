...
namespace Rayzin.Primitives
{
    public static class RzTransforms
    {
        ...
        public static RzMatrix Translation(double x, double y, double z) => new(4, 1, 0, 0, x, 0, 1, 0, y, 0, 0, 1, z, 0, 0, 0, 1);
        public static RzMatrix Scaling(double x, double y, double z) => new(4, x, 0, 0, 0, 0, y, 0, 0, 0, 0, z, 0, 0, 0, 0, 1);
        ...
        public static RzMatrix Shearing(double xToY, double xToZ, double yToX, double yToZ, double zToX, double zToY) => new(4, 1, xToY, xToZ, 0, yToX, 1, yToZ, 0, zToX, zToY, 1, 0, 0, 0, 0, 1);
    }
}
