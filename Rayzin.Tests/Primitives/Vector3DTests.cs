...
namespace Rayzin.Tests.Primitives
{
    ...
    public class Vector3DTests
    {
        ...
        public void Add_TwoVectors_ProducesVector()
        {
            ...
            Assert.That(v3.X, Is.EqualTo(7).Within(Epsilon.Value));
            Assert.That(v3.Y, Is.EqualTo(5).Within(Epsilon.Value));
            Assert.That(v3.Z, Is.EqualTo(3).Within(Epsilon.Value));
        }
        ...
        public void Subtract_TwoVectors_ProducesVector()
        {
            ...
            Assert.That(v3.X, Is.EqualTo(3).Within(Epsilon.Value));
            Assert.That(v3.Y, Is.EqualTo(1).Within(Epsilon.Value));
            Assert.That(v3.Z, Is.EqualTo(-1).Within(Epsilon.Value));
        }
        ...
        public void Negative_Vector_ProducesNegativeVector()
        {
            ...
            Assert.That(v2.X, Is.EqualTo(-4.3).Within(Epsilon.Value));
            Assert.That(v2.Y, Is.EqualTo(4.2).Within(Epsilon.Value));
            Assert.That(v2.Z, Is.EqualTo(-3.1).Within(Epsilon.Value));
        }
        ...
        public void Multiply_VectorByScalar_ProducesMultipliedVector(double x, double y, double z, double scalar, double expectedX, double expectedY, double expectedZ)
        {
            ...
            Assert.That(v2.X, Is.EqualTo(expectedX).Within(Epsilon.Value));
            Assert.That(v2.Y, Is.EqualTo(expectedY).Within(Epsilon.Value));
            Assert.That(v2.Z, Is.EqualTo(expectedZ).Within(Epsilon.Value));
        }
        ...
        public void Magnitude_WithTestCases_ProducesCorrectResults(double x, double y, double z, double expected)
        {
            ...
            Assert.That(v.Magnitude, Is.EqualTo(expected).Within(Epsilon.Value));
        }
            ...
            double x1, double y1, double z1, double x2, double y2, double z2, double expected)
        {
            ...
            Assert.That(output, Is.EqualTo(expected).Within(Epsilon.Value));
        }
            ...
            double x1, double y1, double z1, double x2, double y2, double z2, double expectedX, double expectedY, double expectedZ)
        {
            ...
            Assert.That(output.X, Is.EqualTo(expectedX).Within(Epsilon.Value));
            Assert.That(output.Y, Is.EqualTo(expectedY).Within(Epsilon.Value));
            Assert.That(output.Z, Is.EqualTo(expectedZ).Within(Epsilon.Value));
        }
